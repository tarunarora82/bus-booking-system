...
# Test data - Two different employees trying to book the same bus
$employee1 = @{
    employee_id = "EMP001"
    bus_number = "B001"
...
try {
    $bookings = Invoke-RestMethod -Uri "$apiUrl?action=admin-bookings" -Method GET -ContentType "application/json"
